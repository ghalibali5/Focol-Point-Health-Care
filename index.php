...
$subject = "Focal Point Health Care";

$message = "
<html>
<head>
<title>Focal Point Health Care</title>
</head>
<body>
<table>
<tr>
...
<!--</video>-->
   ...
   <!-- <video id="myVideo" width="320" height="176" controls>
      ...
      <source src="covid.mp4" type="video/ogg">
      Your browser does not support HTML5 video.
    </video> -->
    
    <div style="width:100%;height:0px;position:relative;padding-bottom:56.250%;"><iframe src="https://streamable.com/e/jrudzi?autoplay=1&nocontrols=1" frameborder="0" width="100%" height="100%" allowfullscreen allow="autoplay" style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div>

</header>

<section id="home-sectio2" data-stellar-background-ratio="3" style="background-position: 0px -990px; background-color:#CCCCCC;">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <form id="appointment-form" role="form" method="post" action="#">
                    <!-- SECTION TITLE -->
                    <div id="chge" class="section-title wow fadeInUp animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s;">
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <form id="appointment-form" role="form" method="post" action="index.php">
                        ...
                        <div class="row wow fadeInUp" data-wow-delay="0.8s">
                            <div class="col-md-4 col-sm-4">
                                <label for="text" style="color: white;">Name</label>
